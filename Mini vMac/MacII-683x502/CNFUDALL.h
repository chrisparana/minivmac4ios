...
#define vMacScreenHeight 502
#define vMacScreenWidth 683
...
#define MNVMBundleClassName MacIIEmulator683x502

#ifdef PLIST_PREPROCESSOR
#define MNVMBundleDisplayName Mac II
#define MNVMBundleGetInfoString 8M, 683×503 (iPad Pro 12.9")
#endif
